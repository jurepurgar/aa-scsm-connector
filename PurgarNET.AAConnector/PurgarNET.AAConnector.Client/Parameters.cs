...
namespace PurgarNET.AAConnector.Client
{
    ...
    public static class Parameters
    {
        ...
        public static Uri AZURE_API_URI = new Uri("https://management.azure.com/");
        public static Uri GRAPH_API_URI = new Uri("https://graph.windows.net/");

        public static string AZURE_API_VERSION = "2015-10-31";
        public static string GRAPH_API_VERSION = "1.5";

        public static string AZURE_RESOURCE = "https://management.core.windows.net/";
        ...
        public static string TOKEN_URL = "https://login.windows.net/{0}/oauth2/token?api-version=1.0";
        ...
        public static Uri GetTokenUri(Guid tenantId)
        {
        ...
        public static Uri GetTokenUri(string tenant = null)
        {
        ...
        public static string GetUrlEncodedResource()
        {
